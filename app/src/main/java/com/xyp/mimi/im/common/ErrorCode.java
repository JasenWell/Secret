package com.xyp.mimi.im.common;

import android.app.Application;

import com.xyp.mimi.R;
import com.xyp.mimi.im.net.SealTalkUrlCode;
 ...
 * <p>
 * API 类型的错误码规则：
 * 每个 API 的错误码由 API 的 url 对应的代码{@link com.xyp.mimi.im.net.SealTalkUrlCode} + API 对应的错误码
