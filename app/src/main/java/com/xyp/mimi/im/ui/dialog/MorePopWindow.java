package com.xyp.mimi.im.ui.dialog;
...
public class MorePopWindow extends PopupWindow {
    ...
    public void hideChildView(int id){
        contentView.findViewById(id).setVisibility(View.GONE);
    }

    public void showChildView(int id){
        contentView.findViewById(id).setVisibility(View.VISIBLE);
    }
}
