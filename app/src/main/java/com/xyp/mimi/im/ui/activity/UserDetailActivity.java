...
import com.xyp.mimi.im.event.DeleteFriendEvent;
...
import com.xyp.mimi.im.viewmodel.UserDetailViewModel;
...
public class UserDetailActivity extends TitleBaseActivity implements View.OnClickListener {
    ...
    private ResponseUserInfo latestUserInfo;
    ...
    private void initViewModel() {
        ...
        userDetailViewModel.getUserInfo().observe(this, resource -> {
            if (resource.data != null
                ...
                updateUserInfo(resource.data.getUser());
            }
        });
...
//        }
     ...
     * @param userInfo
     */
    private void updateUserInfo(ResponseUserInfo userInfo) {
        ...
        if (friendStatus == FriendStatus.IS_FRIEND
            ...
            String alias = userInfo.getUserName();
            if (!TextUtils.isEmpty(alias)) {
                // 当有备注名时，主显示备注名，在底部显示额外的用户昵称
                userDisplayNameTv.setText(alias);
                userNameTv.setVisibility(View.VISIBLE);
                String name = getString(R.string.seal_mine_my_account_nickname) + ":" + userInfo.getUserName();
                userNameTv.setText(name);
            } else {
                // 当没有备注名时，主显示用户昵称，隐藏底部额外显示
                userDisplayNameTv.setText(userInfo.getUserName());
...
//        userDisplayNameTv.setCompoundDrawables(null, null, drawable, null);
        // 更新头像
        ImageLoaderUtils.displayUserPortraitImage(userInfo.getImgUrl(), userPortraitIv);
    }
...
//        dialog.show(getSupportFragmentManager(), null);
    ...
    private void startChat() {
        RongIM.getInstance().startPrivateChat(this, latestUserInfo.getId(), latestUserInfo.getUserName());
        finish();
    }
