...
public class FriendTask {
    ...
    public LiveData<List<PhoneContactInfo>> searchPhoneContactInfo(String keyword) {
        ...
        if (friendDao != null) {
            ...
            searchPhoneContactInfo = new MutableLiveData<>();
        }
