 ...
 */
public class ConversationFragmentEx extends ConversationFragment implements IBaseCallBack {
...
//    }
    ...
    public void onSuccess(Object object, int type) {
        ...
        if(type == HttpHelper.BUSINESS.REQUEST_CHAT_SINGLE.getCode()){
    ...
    private Handler myHandler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what == 1910){
                asynModelImp.sendRequest(HttpHelper.BUSINESS.REQUEST_CHAT_SINGLE,Params.startSingleChatParams(UserCache.getInstance().getCurrentUserId(),getTargetId(), (String) msg.obj));
            }
        }
    };
