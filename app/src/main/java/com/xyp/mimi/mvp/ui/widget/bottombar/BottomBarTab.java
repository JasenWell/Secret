package com.xyp.mimi.mvp.ui.widget.bottombar;
...
//        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.bottom_navigation_unselected));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected&&getTabPosition()!=0) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.bottom_color));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.bottom_color));
        } else {
            if(getTabPosition()!=0){
