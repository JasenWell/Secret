...
public interface CircleContract {
    ...
    interface CircleListView extends IView {
        ...
        void  getCircleListResult(BaseResponse s);
    }
    ...
    interface Model extends IModel {
        ...
        Observable<BaseResponse> getCircleList(CirclePost circlePost);

        Observable<BaseResponse> pushCircle(CirclePost circlePost);
    }
}
