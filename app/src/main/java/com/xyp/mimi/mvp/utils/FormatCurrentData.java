...
//    private static final int seconds_of_30minutes = 30 * 60;
    ...
    private static final int seconds_of_2day = 48 * 60 * 60;
...
//        }
        ...
        if ( elapsedTime>seconds_of_1day && elapsedTime < seconds_of_2day) {

            return   "昨天 "+  mTime.substring(11,16);
        }

        if (elapsedTime > seconds_of_2day) {
            return    mTime.substring(5,7)+"月"
                    +mTime.substring(8,10)+"日 ";
        }
