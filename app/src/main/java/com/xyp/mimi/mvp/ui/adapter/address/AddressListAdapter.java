...
public class AddressListAdapter extends BaseQuickAdapter<AddressListResult.DataBean, BaseViewHolder> {
    ...
    public AddressListAdapter(@Nullable List<AddressListResult.DataBean> data) {
...
//        });
    ...
    private AddressListAdapter.OnClickInvoiceDefaultListener onClickInvoiceDefaultListener;


    public void setOnInvoiceDefaultListener(AddressListAdapter.OnClickInvoiceDefaultListener onInvoiceDefaultListener){
