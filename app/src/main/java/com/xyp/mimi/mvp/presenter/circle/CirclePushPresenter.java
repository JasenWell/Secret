 ...
 */
@ActivityScope
public class CirclePushPresenter extends BasePresenter<CircleContract.Model, CircleContract.PushCircleView> {
    @Inject
    ...
    @Inject
    public CirclePushPresenter(CircleContract.Model model, CircleContract.PushCircleView rootView) {
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse>(mErrorHandler) {
                    ...
                    public void onNext(BaseResponse baseResponse) {
                        if(baseResponse.getCode() == 0){
                            mRootView.pushCircleResult(baseResponse);
                        }else{
