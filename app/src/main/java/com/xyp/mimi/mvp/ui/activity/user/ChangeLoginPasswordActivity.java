...
import com.xyp.mimi.mvp.presenter.user.LoginPasswordPresenter;
...
public class ChangeLoginPasswordActivity extends BaseSupportActivity<LoginPasswordPresenter> implements UserContract.LoginPasswordView {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerUserComponent.builder()
                ...
                .build()
                .injectChangeLoginPassword(this);
    }

    @Override
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_change_login_password; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_commit:
                ...
                if (mPresenter != null) {
                    mPresenter.changeLoginPassword(new UserLoginPasswordPost(userId,token,phone,password,code));
                }
                break;
    ...
    private void getCode() {
        ...
        mPresenter.getCode(new UserCodePost(userId,token,phone,0));
        countDown();
    }
